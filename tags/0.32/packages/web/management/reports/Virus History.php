...
?>
<h2><?php print _("FOG Virus Summary")." (<a href=\"?node=$_GET[node]&sub=$_GET[sub]&f=$_GET[f]&delvid=all\">"._("clear all history")."</a>) <a href=\"export.php?type=csv\" target=\"_blank\"><img class=\"noBorder\" src=\"images/csv.png\" /></a> <a href=\"export.php?type=pdf\" target=\"_blank\"><img class=\"noBorder\" src=\"images/pdf.png\" /></a>"; ?></h2>
<?php

$report = new ReportMaker();
$report->appendHTML("<table cellpadding=0 cellspacing=0 border=0 width=100%>");
	$report->appendHTML("<tr bgcolor=\"#BDBDBD\"><td>&nbsp;<b>"._("Host Name")."</b></td><td>&nbsp;<b>"._("Virus Name")."</b></td><td><b>"._("File")."</b></td><td><b>"._("Mode")."</b></td><td><b>"._("Date")."</b></td><td><b>"._("Clear")."</b></td></tr>");		
	
	$report->addCSVCell(_("Host Name"));
	$report->addCSVCell(_("Virus Name"));
	$report->addCSVCell(_("File"));
	$report->addCSVCell(_("Mode"));
	$report->addCSVCell(_("Date"));
	$report->endCSVLine();												
		...
		{
			$report->appendHTML("<tr><td colspan=\"5\" class=\"c\">"._("No Virus Information Reported.")."</td></tr>" );
			$report->addCSVCell(_("No Virus Information Reported."));
			$report->endCSVLine();						
		}
