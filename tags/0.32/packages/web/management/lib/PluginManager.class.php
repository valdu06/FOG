...
class PluginManager
{
	...
	public function __construct( $conn, $location )
	{
		$this->dbConn = $conn;
...
class Plugin
{
	private $strName, $strDesc, $strEntryPoint, $strVersion, $strPath;
	private $strIcon, $strIconHover;
	private $blIsInstalled, $blIsActive;

	public function __construct( $rootpath, $name, $desc, $entrypoint, $icon=null, $iconhover=null )
	{
		$this->strName = $name;
		$this->strDesc = $desc;
		$this->strEntryPoint = $entrypoint;
		$this->strIcon = $icon;
		$this->strIconHover = $iconhover;
		$this->strPath = $rootpath;
	}
	
	public function setIsInstalled( $installed )
	{
		$this->blIsInstalled = $installed;
	}
	
	public function setIsActive( $active )
	{
		$this->blIsActive = $active;
	}
	...
	public function isInstalled()   { return $this->blIsInstalled; }
	public function isActive()	{ return $this->blIsActive; }
