...
public class SshToolsApplicationInternalFrame
  ...
  protected StandardAction faqAction;
  protected StandardAction beginnerAction;
  protected StandardAction advancedAction;
  ...
  public void closeContainer() {
    ...
    getApplicationPanel().deregisterAction(changelogAction);
    getApplicationPanel().deregisterAction(faqAction);
    getApplicationPanel().deregisterAction(beginnerAction);
    getApplicationPanel().deregisterAction(advancedAction);
    getApplicationPanel().rebuildActionComponents();
  }
