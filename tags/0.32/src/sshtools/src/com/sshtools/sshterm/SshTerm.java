...
public class SshTerm
  ...
  public String getApplicationVersion() {
    return "version @APPLICATION_VERSION_MAJOR@.@APPLICATION_VERSION_MINOR@\nBuilt on @BUILD_DATE@ at @BUILD_SITE@";
  }
  ...
  public String getAboutURL() {
    return "http://www.grid-support.ac.uk/content/view/81/195/";
  }
