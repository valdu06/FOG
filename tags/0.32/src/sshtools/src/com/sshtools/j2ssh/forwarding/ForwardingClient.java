...
public class ForwardingClient
  ...
  public void removeRemoteForwarding(String name) throws IOException,
    ...
    ForwardingConfiguration config = (ForwardingConfiguration) remoteForwardings
        .get(name);

    if (config.getState().getValue()==StartStopState.STARTED) {
   ...
   * @throws ForwardingConfigurationException
   */
  public ForwardingConfiguration addRemoteForwarding(String uniqueName, String addressToBind,
    ...
    // Create the configuration object
    ForwardingConfiguration cf = new ForwardingConfiguration(uniqueName, addressToBind,
							     portToBind,
