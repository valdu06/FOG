    ...
    if (pf.table.getSelectedRowCount() == 0 || pf.table.getRowCount() == 0) {
      ...
      if (pf.table.getSelectedRowCount() > 1) {
        ...
        for (int i = 0; i < pf.table.getSelectedRowCount(); i++) {
          if (pf.model.getForwardingConfigurationAt(i).isForwarding() && !pf.model.getForwardingConfigurationAt(i).getName().equals("x11")) {
            stopAction.setEnabled(true);
            stopImmediatelyAction.setEnabled(true);
          }
          else {
	      if(!pf.model.getForwardingConfigurationAt(i).getName().equals("x11")) {
        ...
        startAction.setEnabled(!pf.selectedTunnelName().equals("x11") && !pf.isSelectedTunnelStarted());
        stopAction.setEnabled(!pf.selectedTunnelName().equals("x11") && pf.isSelectedTunnelStarted());
        stopImmediatelyAction.setEnabled(!pf.selectedTunnelName().equals("x11") && pf.isSelectedTunnelStarted());
        removeAction.setEnabled(!pf.selectedTunnelName().equals("x11") && !pf.isSelectedTunnelStarted());
        editTunnelsAction.setEnabled(!pf.selectedTunnelName().equals("x11") /*!pf.isSelectedTunnelStarted()*/);
      }
    }
  }
