...
?>
<h2><?php print _("User Login History"); ?></h2>
<?php


echo ( "<table cellpadding=0 cellspacing=0 border=0 width=100%>" );
echo ( "<tr class=\"header\"><td>&nbsp;<b>"._("Host Name")."</b></td><td>&nbsp;<b>"._("Virus Name")."</b></td><td><b>"._("File")."</b></td><td><b>"._("Mode")."</b></td><td><b>"._("Date")."</b></td><td><b>"._("Clear")."</b></td></tr>" );
$sql = "SELECT 
		* 
	FROM 
		virus 
