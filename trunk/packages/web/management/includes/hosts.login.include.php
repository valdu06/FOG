...
if ( $currentUser != null && $currentUser->isLoggedIn() )
{
	...
	if ( is_numeric( $id ) )
	{
		...
		echo ( "<p>View History for " );
			...
			echo ( "<form id=\"dte\" method=\"post\" action=\"?node=$_GET[node]&sub=$_GET[sub]&id=$_GET[id]\">" );
		...
		echo ( "<tr class=\"header\"><td><b>&nbsp;"._("Action")."</b></td><td><b>&nbsp;"._("Username")."</b></font></td><td><b>&nbsp;"._("Time")."</b></td><td><b>&nbsp;"._("Description")."</b></td></tr>" );		
		$cnt = 0;
		$arAllUsers = array();
		while( $ar = mysql_fetch_array( $res ) )
		{
