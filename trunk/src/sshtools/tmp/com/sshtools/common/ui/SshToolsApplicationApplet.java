...
public abstract class SshToolsApplicationApplet
  ...
  public class SshToolsApplicationAppletContainer
    ...
    public void init(SshToolsApplication application,
      ...
      panel.registerAction(new ChangelogAction(this, application));
      panel.registerAction(new FAQAction());
      panel.registerAction(new AdvancedAction());
      panel.registerAction(new BeginnerAction());
